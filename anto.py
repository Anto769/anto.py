...
\033[0;94m  _   _  _ _____ ___      

\033[0;94m /_\ | \| |_   _/ _ \

\033[0;96m  / _ \| .` | | || (_) |

\033[0;96m /_/ \_\_|\_| |_| \___/

""")

 

print("\033[0;91mThis Tool's Free By AR ANTO")
...
def menu():
    ...
    print '\033[0;93mAUTHOR   : Ar Anto'

    print '\033[0;94mFACEBOOK : A N TO '

    print '\033[0;96mGITHUB   : 🙂✌️'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;92m[AR ANTO-HACKED]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                ...
                print '\x1b[1;91m[AR ANTO-CP]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\x1b[1;92m \x1b[0m \n'
